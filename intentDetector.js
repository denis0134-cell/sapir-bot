...
MORNING_CHECKIN  — צ'ק אין בוקר / שאלות בוקר
EVENING_CHECKIN  — סיכום יום / צ'ק אין ערב
...
WEEKLY_REPORT    — דוח שבועי / סיכום שבוע
LIFE_DASHBOARD   — דשבורד / מצב כולל / תמונה כוללת / מה הציון שלי
SCORE_CHECK      — בדיקת ציונים ספציפית (בריאות/מכירות/פרודוקטיביות)
UPDATE_LEAD_FULL — עדכון ליד עם פרטים מלאים (חום, סבירות, פולואפ הבא)
SAVE_CHECKIN     — שליחת תשובות לשאלות הצ'ק אין (מספרות 1. 2. 3. ...)
